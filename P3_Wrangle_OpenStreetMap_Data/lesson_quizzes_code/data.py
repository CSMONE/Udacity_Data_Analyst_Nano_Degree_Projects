...
def shape_element(element, node_attr_fields=NODE_FIELDS, way_attr_fields=WAY_FIELDS,
   ...
   #     node_attribs['id']=int(element.get('id'))
   #     node_attribs['user']=element.get('user')
   #     node_attribs['uid']=int(element.get('uid'))
   #     node_attribs['version']=element.get('version')
   #     node_attribs['lat']=float(element.get('lat'))
   #     node_attribs['lon']=float(element.get('lon'))
   #     node_attribs['timestamp']=element.get('timestamp')
    #    node_attribs['changeset']=int(element.get('changeset'))
  ...
  #      way_attribs['id']=int(element.get('id'))
  #      way_attribs['user']=element.get('user')
  #      way_attribs['uid']=int(element.get('uid'))
 #       way_attribs['version']=element.get('version')
  #      way_attribs['timestamp']=element.get('timestamp')
  #      way_attribs['changeset']=int(element.get('changeset'))
